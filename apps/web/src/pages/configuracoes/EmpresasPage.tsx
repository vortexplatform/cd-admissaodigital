  ...
  return (
    <>
      <PageHeader
        ...
        description="Cadastre, edite e remova empresas usadas nos fluxos de admissão e integração Senior."
      />
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {errors.codigoEmpresaSenior && (
                  <p className="text-sm text-destructive">{errors.codigoEmpresaSenior.message}</p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                <Button type="submit" disabled={isSaving} className="w-full">
                  ...
                  {isSaving ? 'Salvando...' : editingEmpresa ? 'Salvar alterações' : 'Cadastrar'}
                </Button>
                {editingEmpresa && (
